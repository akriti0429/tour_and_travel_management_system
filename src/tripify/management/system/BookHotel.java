...
public class BookHotel extends JFrame implements ActionListener{
	...
	BookHotel(String username) {
	    setBounds(320, 120, 1100, 600);
		contentPane = new JPanel();
		setContentPane(contentPane);  
		contentPane.setLayout(null);
                
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("images/book.jpg"));
                Image i3 = i1.getImage().getScaledInstance(500, 700,Image.SCALE_DEFAULT);
                ImageIcon i2 = new ImageIcon(i3);
                JLabel la1 = new JLabel(i2);
                la1.setBounds(450,0,700,700);
                add(la1);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s1 = c1.getSelectedItem(); 
                                ...
                                String q1 = "insert into bookhotels values('"+la2.getText()+"', '"+lblId.getText()+"', '"+la3.getText()+"', '"+la4.getText()+"', '"+la5.getText()+"', '"+la6.getText()+"', '"+lbl1.getText()+"', '"+lbl2.getText()+"', '"+lbl3.getText()+"', '"+lblDeposite.getText()+"')";
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BookHotel frame = new BookHotel("tanvikaushik0808");
