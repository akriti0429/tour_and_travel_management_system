...
public class ViewHotels extends JFrame implements Runnable{
    ...
    public void run(){
        String[] text = new String[]{"JW Marriott Hotel","Mandarin Oriental Hotel","Four Seasons Hotel","Radisson Hotel","Classio Hotel","The Bay Rest Hotel","Breeze Blows Hotel","Quick Stop Hotel","Happy Mornings Motel","Moss Stay Hotel"};
        try {
            for( int i =0;i<=9;i++){
