...
public class BookedHotel extends JFrame implements ActionListener{
	private JPanel contentPane;
        BookedHotel(String username){
            setBounds(320, 120,850, 600);
		contentPane = new JPanel();
		setContentPane(contentPane);
		contentPane.setLayout(null);
                
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("images/bookedhotel.jpg"));
                Image i3 = i1.getImage().getScaledInstance(600, 400,Image.SCALE_DEFAULT);
                ImageIcon i2 = new ImageIcon(i3);
                JLabel la1 = new JLabel(i2);
                la1.setBounds(400,70,400,400);
                add(la1);
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BookedHotel frame = new BookedHotel("");
